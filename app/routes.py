...
def index():
    ...
    return render_template('index.html', title='Home', posts=posts.items, post_form=form,
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        # Note that the flashed message is displayed even if the email provided by
        # the user is unknown. This is so that clients cannot use this form to figure
        # out if a given user is a member or not.
        flash('Check your email for the instructions to reset your password.')
        return redirect(url_for('login'))
    return render_template('reset_password_request.html', title='Reset Password',
                           reset_password_request_form=form)
...
def reset_password(token):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('login'))
    return render_template('reset_password.html', reset_password_form=form)
